    ...
    try:
        ...
        if plan_request.mode == "extract":
            ...
            if extract_plan.is_split_operation and extract_plan.split_size:
                ...
                # Execute all jobs automatically in the backend
                logger.info("Starting automatic execution of split jobs...")
                successful_jobs = 0
                failed_jobs = 0
                ...
                # Don't include job_id at all to prevent frontend from trying to execute
                return {
                    "mode": "extract",
                    "is_split": True,
